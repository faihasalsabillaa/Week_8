...
void bubbleSortNISN(Student students[], int size) { //in descending order
    bool swapped;
    for(int i = 0; i < size; i++) {
        swapped = false;
...
void bubbleSortValue(Student students[], int size) { //in descending order
    bool swapped;
    for(int i = 0; i < size; i++) {
        swapped = false;
        for(int j = 0; j < false; j++) {
...
int main() {
    ...
    bubbleSortNISN(students, size);
    cout << "Result of data after Bubble sort by NISN: \n";
    displayStudents(students, size);

    bubbleSortValue(students, size);
    cout << "Result of data after Bubble sort by value: \n";
    displayStudents(students, size);
